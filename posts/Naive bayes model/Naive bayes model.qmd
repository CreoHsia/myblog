...
Apply the Naive Bayes classifier to the adult dataset for classification. The data can be found in [Github](https://github.com/CreoHsia/myblog/tree/main/posts/Naive%20bayes%20model)
